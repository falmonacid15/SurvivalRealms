...
public final class GuiLayout {
    ...
    private static final String TEXTURE_PREV  = "eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvZWUzZDgyMjVmOGY1Yjk4NTNlZTZhZjNiMTEwZGJhZjI0MWEyMzVhYzYwMWQ0YTM0NjliNGFjY2VjNzE4YiJ9fX0=";
    ...
    public static void apply(InventoryContents contents, GuiActions actions) {
        ...
        contents.set(SLOT_BACK,  ClickableItem.of(back,  e -> actions.onBack((Player) e.getWhoClicked())));
        contents.set(SLOT_WARPS, ClickableItem.of(warps, e -> actions.onWarps((Player) e.getWhoClicked())));
        contents.set(SLOT_HOME,  ClickableItem.of(home,  e -> actions.onHome((Player) e.getWhoClicked())));
    }
